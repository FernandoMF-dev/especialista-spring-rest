...
public interface ProfileControllerDocumentation {
	...
	ResponseEntity<ProfileDto> findById(@ApiParam(value = "ID of a profile", example = "1") Long id);
	...
	ResponseEntity<ProfileDto> insert(@ApiParam(name = "body", value = "Profile data to create") ProfileDto dto);
	...
	@ApiResponse(responseCode = "404", description = "Profile not found", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class)))
	ResponseEntity<ProfileDto> update(@ApiParam(value = "ID of a profile to update", example = "1") Long id,
									  @ApiParam(name = "body", value = "Profile data to update") ProfileDto dto);

	@ApiOperation("Delete a profile by its ID")
	@ApiResponse(responseCode = "204", description = "Profile deleted")
	@ApiResponse(responseCode = "404", description = "Profile not found", content = @Content(schema = @Schema(implementation = ApiErrorResponse.class)))
	ResponseEntity<Void> delete(@ApiParam(value = "ID of a profile to delete", example = "1") Long id);
}
